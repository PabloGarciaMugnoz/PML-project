...
# remove outliers
trainNoOut <- train[-c(700,3759,9647), ]


par( mfrow = c(1,3))

  plot(as.factor(trainNoOut[ ,53]), trainNoOut[ ,31], 
       main = paste("feature ", names(train)[31]))
  plot(as.factor(trainNoOut[ ,53]), trainNoOut[ ,32], 
       main = paste("feature ", names(train)[32]))
  plot(as.factor(trainNoOut[ ,53]), trainNoOut[ ,44], 
       main = paste("feature ", names(train)[44]))
